...
const char *WINDOWTITLE = "CS450 Project #5: Textures -- Riley Rice";
...
int   NowProjection;  // projection setting
GLuint SphereList;
int   TextureMode;    // texture mode for program
...
Display( )
{
	...
	gluLookAt( 25.f, 8.f, 25.f,     0.f, 0.f, 0.f,     0.f, 1.f, 0.f );
  ...
  switch (TextureMode) {
    case 0: // Texture with GL_MODULATE
      ...
      glBindTexture(GL_TEXTURE_2D, Planets[CurrPlanet].texture);
      glTexEnvf( GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, GL_MODULATE );
      break;
      
    case 1: // Texture with GL_REPLACE
      glEnable(GL_TEXTURE_2D);
      glBindTexture(GL_TEXTURE_2D, Planets[CurrPlanet].texture);
  ...
  glCallList(Planets[CurrPlanet].displayList);
...
InitMenus( )
{
  ...
  for (int i = 0; i < NUMPLANETS; i++) {
    glutAddMenuEntry (Planets[i].name, i);
  }
