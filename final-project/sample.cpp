...
const char *WINDOWTITLE = "CS450 Final Project - Procedural Terrain Generation Using Perlin Noise -- Riley Rice";
...
const GLfloat BACKCOLOR[ ] = { 0.53f, 0.81f, 0.98f, 1.0f };
...
Display( )
{
	...
	gluLookAt( 60.f, 15.f, 60.f,     25.f, 0.f, 25.f,     0.f, 1.f, 0.f );
