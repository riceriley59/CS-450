...
const char *WINDOWTITLE = "CS450 Project #6 Shaders -- Riley Rice";
...
GLuint  SalmonList; // list to hold the helicopter
...
Display( )
{
  ...
  gluLookAt( 14.f, 5.f, 14.f,     0.f, 0.f, 0.f,     0.f, 1.f, 0.f );
  ...
  Pattern.SetUniformVariable((char *) "uKa", 0.2f);
  Pattern.SetUniformVariable((char *) "uKd", 0.4f);
  Pattern.SetUniformVariable((char *) "uKs", 0.4f);
  Pattern.SetUniformVariable((char *) "uShininess", 50.f);
